package com.fir.deer.entity.idGenerator;
...
public class UserIdGenerator  implements IdGenerator{
    ...
    public UserIdGenerator(int userId) {
        this.datacenterId = userId;
    }
    ...
    public static void main(String[] args) throws Exception{
        UserIdGenerator idGenerator = new UserIdGenerator(1133105);
